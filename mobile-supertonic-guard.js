...
window.MobileSupertonicGuard={version:2,policy:'hosted-first-mobile',isMobile:mobile,localAllowed:localAllowed,deviceMemoryGB:memory,message:message,isOomError:isOomError};
