...
window.MobileSupertonicGuard={version:3,policy:'hosted-first-mobile',isMobile:mobile,localAllowed:localAllowed,deviceMemoryGB:memory,message:message,isOomError:isOomError};
