...
const finalStatic={
  mockCacheBust:html.includes('mocktest.js?v=20260822-quality5'),
  ...
  secondaryActionsPlaceCompatible:!js.includes('action2=d.actions.find')&&(js.match(/SCENE_ACTIONS\[level\]\?\.\[place2\]/g)||[]).length>=2,
...
const report={...base,version:'20260822-quality5',naturalnessChecked,finalStatic,failures};
