...
setTimeout(async()=>{try{for(const f of["large_vocab_sources.js","large_vocab_corefix.js","large_vocab_matchers.js","large_vocab_build.js"])await load(`./${f}?v=20260814v6`);await window.JPVocabLarge.build()}catch(e){console.error(e);const x=document.getElementById("advStatus");if(x)x.textContent=`⚠️ 大型詞庫載入失敗：${e.message}`}},0);
})();
