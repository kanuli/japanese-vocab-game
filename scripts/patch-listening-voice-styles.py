...
new_html = '''<div class="source"><strong>🔊 日語語音</strong><div id="voiceStatus" class="muted">正在檢查瀏覽器日語語音…</div><div class="field" style="margin-top:8px"><label style="display:block;font-size:12px;color:var(--muted);font-weight:700;margin-bottom:4px">聲線風格（模擬）</label><select id="voiceStyle" style="width:100%;padding:9px;border:1px solid var(--line);border-radius:9px"><option value="auto">🎛️ 自動</option><option value="standard">👩 標準女聲</option><option value="mature">💋 成熟性感女聲</option><option value="lowsoft">🌙 低沉柔和女聲</option><option value="whisper">💕 親密／耳語風格</option><option value="cute">🌸 可愛女聲</option><option value="male">👨 男聲</option><option value="random">🎲 每題隨機</option></select></div><div class="field" style="margin-top:8px"><label style="display:block;font-size:12px;color:var(--muted);font-weight:700;margin-bottom:4px">裝置日語語音</label><select id="voice" style="width:100%;padding:9px;border:1px solid var(--line);border-radius:9px"><option value="">自動選擇日語語音</option></select></div><div class="muted" style="margin-top:7px">聲線風格以瀏覽器 TTS 的速度、音高與音量模擬；不是模仿任何特定真人。不同裝置的效果會略有不同。</div></div>'''
