...
const out={version:1,generated:new Date().toISOString(),source:'wordaudio runtime-equivalent core + curated + prebuilt advanced + reviewed strict-surface completion layers; entries without Traditional Chinese meaning excluded exactly like runtime',wordCount:words.length,shardCount:SHARDS,coreCount:coreRows.length,advancedCount:advRows.length,countsByLevel:counts,shardCounts,words};
